...
import { setloginpage, virtualgames_images, playsaccount } from "../../redux/actions/auth/loginActions"
...
const mapStateToProps = (state) => ({
  ...
  casinoSlider_images : state.auth.login.virtual_images,
})

const mapDispatchToProps = {
  setloginpage, virtualgames_images, providerchange, gametypechange, filterData, playsaccount, data_load
}
