        ...
        columns: [
          {
            ...
            cell: row => (
                <span>
                   {(new Date(row.createDate)).toLocaleString((new Date()).getTimezoneOffset(),{hour12 : false}).replace(",", "")}
                </span>
            ),
          },
          {
          ...
          },
          {
            ...
            cell: row => (
              <span>
                {row.bankType==='8035'?'Netbanking':row.type}
              </span>
            )
          },
          {
        ...
        <DataTable
          ...
          subHeaderComponent={
            <CustomHeader
              ...
              total={totalRecords}
              index={sortIndex}
              dateLoad={()=>this.props.WithdrawHistoryLoad({
