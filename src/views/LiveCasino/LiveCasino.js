...
import { LiveCasinoItem } from "../Casino/CasinoItem"
...
import { setloginpage, livecasino_images, playsaccount } from "../../redux/actions/auth/loginActions"
              ...
              <div className='casino-games__wrap'>
                ...
                <div className='casino-games__list'>
                  {indata.length > 0 ? indata.map((item,i) => (
                    <LiveCasinoItem key={i} data={item} me={this.props} />
                  )) : null}
                </div>
              </div>
            </div>
...
const mapStateToProps = (state) => ({
  ...
  casinoSlider_images : state.auth.login.livecasino_images,
})

const mapDispatchToProps = {
  setloginpage, livecasino_images, providerchange, gametypechange, filterData, playsaccount, data_load
}
